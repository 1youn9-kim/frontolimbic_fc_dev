...
output_dir = fullfile(Top, 'derivatives/binned_fc_maps_hip_PNC');
...
hip_mask_sub = ismember(parc(subcort_all_idx), [1, 9]); 
...
zscore_col_name = 'deltar_h_zscore';
...
for i = 1:length(age_bins)
    ...
    cifti_write(out_cifti, fullfile(output_dir, sprintf('HipAvgFC_PNC_AgeBin%02d_all.dscalar.nii', age_bins(i))));
    ...
    for g = 1:3
        ...
        cifti_write(out_cifti, fullfile(output_dir, sprintf('HipAvgFC_PNC_AgeBin%02d_%s.dscalar.nii', age_bins(i), g_labs{g})));
...
writematrix(corrmat_m, fullfile(output_dir, 'HipAvgFC_PNC_Denoised_AgeBinYearly_CorrWRef_medial.csv'));
writematrix(corrmat_l, fullfile(output_dir, 'HipAvgFC_PNC_Denoised_AgeBinYearly_CorrWRef_lateral.csv'));
writematrix(corrmat_c, fullfile(output_dir, 'HipAvgFC_PNC_Denoised_AgeBinYearly_CorrWRef.csv'));
writematrix(corrmat_m_all, fullfile(output_dir, 'HipAvgFC_PNC_Denoised_AgeBinYearly_CorrWRef_medial_all.csv'));
writematrix(corrmat_l_all, fullfile(output_dir, 'HipAvgFC_PNC_Denoised_AgeBinYearly_CorrWRef_lateral_all.csv'));
...
for i = 1:3
    ...
    final_map_all = tanh(mean(harmonized_data_z(idx, :), 1, 'omitnan'))';
    out_cifti = template; out_cifti.cdata(ctx_vertex_idx) = final_map_all;
    cifti_write(out_cifti, fullfile(output_dir, sprintf('HipAvgFC_PNC_Denoised_%s_all.dscalar.nii', labs{i})));
    ...
    for g = 1:3
        ...
        final_map = tanh(mean(harmonized_data_z(s_idx, :), 1, 'omitnan'))';
        out_cifti = template; out_cifti.cdata(ctx_vertex_idx) = final_map;
        cifti_write(out_cifti, fullfile(output_dir, sprintf('HipAvgFC_PNC_Denoised_%s_%s.dscalar.nii', labs{i}, g_labs{g})));
...
writematrix(corrmat_m_3, fullfile(output_dir, 'HipAvgFC_PNC_Denoised_AgeBin3Split_CorrWRef_medial.csv'));
writematrix(corrmat_l_3, fullfile(output_dir, 'HipAvgFC_PNC_Denoised_AgeBin3Split_CorrWRef_lateral.csv'));
writematrix(corrmat_c_3, fullfile(output_dir, 'HipAvgFC_PNC_Denoised_AgeBin3Split_CorrWRef.csv'));
writematrix(corrmat_m_all_3, fullfile(output_dir, 'HipAvgFC_PNC_Denoised_AgeBin3Split_CorrWRef_medial_all.csv'));
writematrix(corrmat_l_all_3, fullfile(output_dir, 'HipAvgFC_PNC_Denoised_AgeBin3Split_CorrWRef_lateral_all.csv'));
...
writematrix(corrmat_m_4, fullfile(output_dir, 'HipAvgFC_PNC_Denoised_AgeBin4Split_CorrWRef_medial.csv'));
writematrix(corrmat_l_4, fullfile(output_dir, 'HipAvgFC_PNC_Denoised_AgeBin4Split_CorrWRef_lateral.csv'));
writematrix(corrmat_c_4, fullfile(output_dir, 'HipAvgFC_PNC_Denoised_AgeBin4Split_CorrWRef.csv'));
writematrix(corrmat_m_all_4, fullfile(output_dir, 'HipAvgFC_PNC_Denoised_AgeBin4Split_CorrWRef_medial_all.csv'));
writematrix(corrmat_l_all_4, fullfile(output_dir, 'HipAvgFC_PNC_Denoised_AgeBin4Split_CorrWRef_lateral_all.csv'));
...
writematrix(corrmat_m_2, fullfile(output_dir, 'HipAvgFC_PNC_Denoised_AgeBin2Split_CorrWRef_medial.csv'));
writematrix(corrmat_l_2, fullfile(output_dir, 'HipAvgFC_PNC_Denoised_AgeBin2Split_CorrWRef_lateral.csv'));
writematrix(corrmat_c_2, fullfile(output_dir, 'HipAvgFC_PNC_Denoised_AgeBin2Split_CorrWRef.csv'));
writematrix(corrmat_m_all_2, fullfile(output_dir, 'HipAvgFC_PNC_Denoised_AgeBin2Split_CorrWRef_medial_all.csv'));
writematrix(corrmat_l_all_2, fullfile(output_dir, 'HipAvgFC_PNC_Denoised_AgeBin2Split_CorrWRef_lateral_all.csv'));
fprintf('Done.\n');