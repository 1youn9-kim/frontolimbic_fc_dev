...
session_fc_output_dir = fullfile(Top, 'derivatives', 'BCP', 'session_level_amyg_fc_maps_final');
if ~exist(session_fc_output_dir, 'dir'), mkdir(session_fc_output_dir); end
hcpd_fc_output_dir = fullfile(Top, 'derivatives', 'HCPD', 'session_level_amyg_fc_maps');
if ~exist(hcpd_fc_output_dir, 'dir'), mkdir(hcpd_fc_output_dir); end
final_binned_output_dir = fullfile(Top, 'derivatives', 'HCPD', 'binned_amyg_fc_maps_HCPD');
...
subcortical_amyg_r = 2; subcortical_amyg_l = 10;
...
amyg_mask_subcort = ismember(parc(subcort_all_idx), [subcortical_amyg_l, subcortical_amyg_r]);
...
for i = 1:n_sessions
    ...
    if isfield(data, 'mean_amyg_fc_vs_frontal_cortex')
        raw_fc_data(i, :) = data.mean_amyg_fc_vs_frontal_cortex;
    elseif isfield(data, 'mean_hipp_fc_vs_frontal_cortex')
...
is_hcpd_row = strcmp(master_covariates.Dataset, 'HCPD');
...
raw_fc_data_z = harmonized_master_fc_z(is_hcpd_row, :);
subs_metadata = master_covariates(is_hcpd_row, :);
...
for i = 1:length(age_bins)
    ...
    cifti_write(output_cifti_all, fullfile(final_binned_output_dir, sprintf('AmygAvgFC_HCPD_Denoised_AgeBin%02d_all.dscalar.nii', age_val)));
    ...
    for g = 1:length(group_keys)
        ...
        cifti_write(output_cifti, fullfile(final_binned_output_dir, sprintf('AmygAvgFC_HCPD_Denoised_AgeBin%02d_%s.dscalar.nii', age_val, group_labels{g})));
...
writematrix(corrmat_medial, fullfile(final_binned_output_dir, 'AmygAvgFC_HCPD_Denoised_AgeBinYearly_CorrWRef_medial.csv'));
writematrix(corrmat_lateral, fullfile(final_binned_output_dir, 'AmygAvgFC_HCPD_Denoised_AgeBinYearly_CorrWRef_lateral.csv'));
writematrix(corrmat_combined, fullfile(final_binned_output_dir, 'AmygAvgFC_HCPD_Denoised_AgeBinYearly_CorrWRef.csv'));
writematrix(corrmat_medial_all, fullfile(final_binned_output_dir, 'AmygAvgFC_HCPD_Denoised_AgeBinYearly_CorrWRef_medial_all.csv'));
writematrix(corrmat_lateral_all, fullfile(final_binned_output_dir, 'AmygAvgFC_HCPD_Denoised_AgeBinYearly_CorrWRef_lateral_all.csv'));
...
for i = 1:3
    ...
    output_cifti_all = template_scalar;
    output_cifti_all.cdata(ctx_vertex_idx) = final_group_map_all_r';
    cifti_write(output_cifti_all, fullfile(final_binned_output_dir, sprintf('AmygAvgFC_HCPD_Denoised_%s_all.dscalar.nii', age_bin_labels{i})));
    ...
    for g = 1:length(g_keys)
        ...
        output_cifti = template_scalar;
        output_cifti.cdata(ctx_vertex_idx) = final_group_map_r';
        cifti_write(output_cifti, fullfile(final_binned_output_dir, sprintf('AmygAvgFC_HCPD_Denoised_%s_%s.dscalar.nii', age_bin_labels{i}, g_labels{g})));
...
writematrix(corrmat_medial_3split, fullfile(final_binned_output_dir, 'AmygAvgFC_HCPD_Denoised_AgeBin3Split_CorrWRef_medial.csv'));
writematrix(corrmat_lateral_3split, fullfile(final_binned_output_dir, 'AmygAvgFC_HCPD_Denoised_AgeBin3Split_CorrWRef_lateral.csv'));
writematrix(corrmat_combined_3split, fullfile(final_binned_output_dir, 'AmygAvgFC_HCPD_Denoised_AgeBin3Split_CorrWRef.csv'));
writematrix(corrmat_medial_all_3split, fullfile(final_binned_output_dir, 'AmygAvgFC_HCPD_Denoised_AgeBin3Split_CorrWRef_medial_all.csv'));
writematrix(corrmat_lateral_all_3split, fullfile(final_binned_output_dir, 'AmygAvgFC_HCPD_Denoised_AgeBin3Split_CorrWRef_lateral_all.csv'));
...
writematrix(corrmat_medial_4split, fullfile(final_binned_output_dir, 'AmygAvgFC_HCPD_Denoised_AgeBin4Split_CorrWRef_medial.csv'));
writematrix(corrmat_lateral_4split, fullfile(final_binned_output_dir, 'AmygAvgFC_HCPD_Denoised_AgeBin4Split_CorrWRef_lateral.csv'));
writematrix(corrmat_combined_4split, fullfile(final_binned_output_dir, 'AmygAvgFC_HCPD_Denoised_AgeBin4Split_CorrWRef.csv'));
writematrix(corrmat_medial_all_4split, fullfile(final_binned_output_dir, 'AmygAvgFC_HCPD_Denoised_AgeBin4Split_CorrWRef_medial_all.csv'));
writematrix(corrmat_lateral_all_4split, fullfile(final_binned_output_dir, 'AmygAvgFC_HCPD_Denoised_AgeBin4Split_CorrWRef_lateral_all.csv'));
...
writematrix(corrmat_medial_2split, fullfile(final_binned_output_dir, 'AmygAvgFC_HCPD_Denoised_AgeBin2Split_CorrWRef_medial.csv'));
writematrix(corrmat_lateral_2split, fullfile(final_binned_output_dir, 'AmygAvgFC_HCPD_Denoised_AgeBin2Split_CorrWRef_lateral.csv'));
writematrix(corrmat_combined_2split, fullfile(final_binned_output_dir, 'AmygAvgFC_HCPD_Denoised_AgeBin2Split_CorrWRef.csv'));
writematrix(corrmat_medial_all_2split, fullfile(final_binned_output_dir, 'AmygAvgFC_HCPD_Denoised_AgeBin2Split_CorrWRef_medial_all.csv'));
writematrix(corrmat_lateral_all_2split, fullfile(final_binned_output_dir, 'AmygAvgFC_HCPD_Denoised_AgeBin2Split_CorrWRef_lateral_all.csv'));
